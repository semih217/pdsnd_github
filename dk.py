...
# df['Start Time'] = pd.to_datetime(df['Start Time'])# df['hour'] = df['Start Time'].dt.hour
...
start_time = time.time()# variable to show how long the
function takes

# display the most common month

df['Start Time'] = pd.to_datetime(df['Start Time'])# changes values of column 'Start Time'
into datetime - format# change of format is needed to pandas methods dt.month etc.
